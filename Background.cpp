...
Background::Background(int BG_ID, SDL_Renderer* ren) {
	...
	switch (BG_ID) {
	case 0:
		this->BG_Sur = IMG_Load("../images/GolfBG.png");
		break;
	case 1:
		this->BG_Sur = IMG_Load("../images/GolfBG1.png");
		break;
	case 2:
		this->BG_Sur = IMG_Load("../images/GolfBG2.png");
		break;
	case 3:
		this->BG_Sur = IMG_Load("../images/GolfBG3.png");
		break;
	}
