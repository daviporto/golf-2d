...
Level2::Level2() {
	...
	this->obstacle = new Obstacle(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
		IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs.png")),
		0, 200, 200, 32,32);
	...
	this->obstacle_2 = new Obstacle(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
		IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs1.png")),
		1, 600, 600,32,32);
	...
	/*
	SDL_RenderCopy(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
		IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs.png")), NULL, this->obstacle->Get_pbrect());
	SDL_RenderCopy(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
	IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs1.png")), NULL, this->obstacle_1->Get_pbrect());
	SDL_RenderCopy(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
	IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs2.png")), NULL, this->obstacle_2->Get_pbrect());
	SDL_RenderCopy(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
	IMG_Load("C:\\Users\\User\\OneDrive\\Imagens\\Obs3.png")), NULL, this->obstacle_3->Get_pbrect());
	*/
	SDL_RenderCopy(this->Get_Main_Launcher_Render(), SDL_CreateTextureFromSurface(this->Get_Main_Launcher_Render(),
